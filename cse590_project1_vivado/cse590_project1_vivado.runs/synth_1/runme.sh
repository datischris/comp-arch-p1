...
HD_PWD='C:/Users/chris/cse590_project1_vivado/cse590_project1_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_datapath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_datapath.tcl
