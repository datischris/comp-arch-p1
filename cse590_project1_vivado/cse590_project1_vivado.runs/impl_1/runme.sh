...
HD_PWD='C:/Users/chris/cse590_project1_vivado/cse590_project1_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_datapath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_datapath.tcl -notrace
